...
var map = new ol.Map({
    ...
    layers: layersList,
    view: new ol.View({
        extent: [-8238207.803408, 4973346.746125, -8236556.841423, 4974601.143388], maxZoom: 28, minZoom: 1
    })
});


map.getView().fit([-8238207.803408, 4973346.746125, -8236556.841423, 4974601.143388], map.getSize());
